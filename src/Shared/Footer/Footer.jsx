    ...
    <footer className="footer p-10 bg-slate-700 text-neutral-content">
      <aside>
       ...
       <svg
        ...
        <h1 className="text-5xl text-[#F89A67] font-bold">
            Task<span className=" text-slate-50">mate</span>
          </h1>
       </div>
        <p>
          Taskmate Industries Ltd.
          <br />
      ...
      <nav>
        ...
        <div className="grid grid-flow-col gap-4 text-2xl">
          ...
          <a target="_blank" href="">
            <FaGithubSquare className="https://github.com/naymHdev" />
          </a>
        </div>
      </nav>
    </footer>
