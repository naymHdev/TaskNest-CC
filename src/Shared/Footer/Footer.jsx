...
const Footer = () => {
  return (
    <div>
      <footer className="footer mt-16 p-2 md:mt-0 md:p-10 bg-base-200 text-base-content">
        <aside>
          <h2 className="text-4xl font-bold text-gray-800">
            <span className=" text-orange-400">Task</span>mate
          </h2>
          <p>
            Join millions of people who organize <br /> work and life with
            Todoist.
          </p>
        </aside>
          ...
          <nav>
            ...
            <div className=" flex gap-3 items-center text-3xl">
              ...
              <a
                ...
                href="https://github.com/naymhossen1b"
              >
                <FaGithubSquare />
              </a>
              <a
